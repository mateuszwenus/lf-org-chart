package com.github.mateuszwenus.lf_org_chart.service_builder.service.messaging;

import com.github.mateuszwenus.lf_org_chart.service_builder.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
    ...
    protected void doReceive(Message message) throws Exception {
        ...
        if (command.equals("undeploy") &&
            ...
            SessionCustomActionLocalServiceUtil.clearService();
        }
    }
}
